...
- 入口脚本：`.cursor/skills/color-palette-generator/scripts/generate_color_palette.py`
...
```powershell
python ".cursor/skills/color-palette-generator/scripts/generate_color_palette.py" `
