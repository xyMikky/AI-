...
# ── 路径推断 ─────────────────────────────────────────────────────────────────
SCRIPT_DIR   = Path(__file__).resolve().parent          # .codex/skills/.../scripts/
SKILL_DIR    = SCRIPT_DIR.parent                        # .codex/skills/.../
CODEX_DIR   = SKILL_DIR.parent.parent                  # .codex/
PROJECT_ROOT = CODEX_DIR.parent                        # 项目根目录
