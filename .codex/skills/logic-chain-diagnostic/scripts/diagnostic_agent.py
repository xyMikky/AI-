...
检查维度：
  ...
  D3 规则引用完整性 — .codex/rules 中的规则是否引用了真实存在的文件
...
class DiagnosticConfig:
    ...
    MODULE_REGISTRY = {
        "M1":  ".codex/skills/brand-logo-designer/SKILL.md",
        "M2":  ".codex/skills/color-system-designer/SKILL.md",
        "M3":  ".codex/skills/typography-designer/SKILL.md",
        "M4":  ".codex/skills/ui-ux-designer/SKILL.md",
        "M5":  ".codex/skills/print-poster-designer/SKILL.md",
        "M6":  ".codex/skills/non-ai-design-reviewer/SKILL.md",
        "M7":  ".codex/skills/design-proposal-writer/SKILL.md",
        "M8":  ".codex/skills/ai-image-prompt-builder/SKILL.md",
        "M9":  ".codex/skills/ai-image-aesthetic-scorer/SKILL.md",
        "M10": ".codex/skills/reference-library-learner/SKILL.md",
        "M11": ".codex/skills/market-platform-analyzer/SKILL.md",
        "M12": ".codex/skills/design-relation-visualizer/SKILL.md",
        "M13": ".codex/skills/design-requirement-guide/SKILL.md",
        "M14": ".codex/skills/video-prompt-designer/SKILL.md",
        "M15": ".codex/skills/detail-page-designer/SKILL.md",
        "M16": ".codex/skills/ai-image-logic-checker/SKILL.md",
        "M17": ".codex/skills/brand-spec-learner/SKILL.md",
        "M18": ".codex/skills/logic-chain-diagnostic/SKILL.md",
    }

    # V8.0：保留的强制 Rule（8 条硬约束 + 4 条流程协调 = 12 条）
    RULE_FILES = [
        ".codex/rules/ai-designer-assistant.mdc",
        ".codex/rules/batch-image-concurrent.mdc",
        ".codex/rules/color-palette-authority.mdc",
        ".codex/rules/design-must-use-main-control.mdc",
        ".codex/rules/image-logic-check.mdc",
        ".codex/rules/mandatory-requirement-guidance.mdc",
        ".codex/rules/p-domain-save.mdc",
        ".codex/rules/prompt-hygiene-no-internal-ids.mdc",
        ".codex/rules/ref-image-must-include.mdc",
        ".codex/rules/user-color-preferences.mdc",
        ".codex/rules/vector-search-integration.mdc",
        ".codex/rules/x-domain-save.mdc",
    ]

    # V8.0：双层 Skill 注册表（业务 18 + 工具 9 = 27，logic-chain-diagnostic 双重身份不重复计数）
    SKILL_DIRS = {
        # ── 业务层 Skill（18 个）
        "brand-logo-designer":          ".codex/skills/brand-logo-designer/SKILL.md",
        "color-system-designer":        ".codex/skills/color-system-designer/SKILL.md",
        "typography-designer":          ".codex/skills/typography-designer/SKILL.md",
        "ui-ux-designer":               ".codex/skills/ui-ux-designer/SKILL.md",
        "print-poster-designer":        ".codex/skills/print-poster-designer/SKILL.md",
        "non-ai-design-reviewer":       ".codex/skills/non-ai-design-reviewer/SKILL.md",
        "design-proposal-writer":       ".codex/skills/design-proposal-writer/SKILL.md",
        "ai-image-prompt-builder":      ".codex/skills/ai-image-prompt-builder/SKILL.md",
        "ai-image-aesthetic-scorer":    ".codex/skills/ai-image-aesthetic-scorer/SKILL.md",
        "reference-library-learner":    ".codex/skills/reference-library-learner/SKILL.md",
        "market-platform-analyzer":     ".codex/skills/market-platform-analyzer/SKILL.md",
        "design-relation-visualizer":   ".codex/skills/design-relation-visualizer/SKILL.md",
        "design-requirement-guide":     ".codex/skills/design-requirement-guide/SKILL.md",
        "video-prompt-designer":        ".codex/skills/video-prompt-designer/SKILL.md",
        "detail-page-designer":         ".codex/skills/detail-page-designer/SKILL.md",
        "ai-image-logic-checker":       ".codex/skills/ai-image-logic-checker/SKILL.md",
        "brand-spec-learner":           ".codex/skills/brand-spec-learner/SKILL.md",
        "logic-chain-diagnostic":       ".codex/skills/logic-chain-diagnostic/SKILL.md",
        # ── 工具层 Skill（8 个，logic-chain-diagnostic 已在业务层注册不重复）
        "ai-persona-architect":         ".codex/skills/ai-persona-architect/SKILL.md",
        "brand-asset-sheet":            ".codex/skills/brand-asset-sheet/SKILL.md",
        "color-palette-generator":      ".codex/skills/color-palette-generator/SKILL.md",
        "layout-reference-analyzer":    ".codex/skills/layout-reference-analyzer/SKILL.md",
        "nano-banana-prompt-guide":     ".codex/skills/nano-banana-prompt-guide/SKILL.md",
        "rh-image-pro-img2img":         ".codex/skills/rh-image-pro-img2img/SKILL.md",
        "rh-image-pro-txt2img":         ".codex/skills/rh-image-pro-txt2img/SKILL.md",
        "skill-converter":              ".codex/skills/skill-converter/SKILL.md",
    }

    SKILL_SCRIPTS = {
        "rh-image-pro-img2img": [
            ".codex/skills/rh-image-pro-img2img/scripts/generate_image.py",
            ".codex/skills/rh-image-pro-img2img/scripts/brand_asset_sheet.py",
        ],
        "rh-image-pro-txt2img": [
            ".codex/skills/rh-image-pro-txt2img/scripts/generate_image_t2i.py",
        ],
        "brand-asset-sheet": [
            ".codex/skills/brand-asset-sheet/scripts/generate_brand_asset_sheet.py",
        ],
        "color-palette-generator": [
            ".codex/skills/color-palette-generator/scripts/generate_color_palette.py",
        ],
        "logic-chain-diagnostic": [
            ".codex/skills/logic-chain-diagnostic/scripts/diagnostic_agent.py",
        ],
    }
    ...
    MAIN_FLOW_GATES = {
        "①_主控中心":           ["主控中心.txt"],
        "②_需求引导":           [".codex/skills/design-requirement-guide/SKILL.md"],
        "③_场景分析":           [".codex/skills/market-platform-analyzer/SKILL.md"],
        "④_配色协同(可选)":     [".codex/skills/color-system-designer/SKILL.md"],
        "⑤_排版协同(可选)":     [".codex/skills/typography-designer/SKILL.md"],
        "⑥_构图协同(可选)":     [".codex/skills/print-poster-designer/SKILL.md"],
        "⑦_AI生图Prompt构造":  [".codex/skills/ai-image-prompt-builder/SKILL.md"],
        "⑦.5_品牌资产合成":     [".codex/skills/brand-asset-sheet/SKILL.md"],
        "⑦.6_色卡渲染(可选)":   [".codex/skills/color-palette-generator/SKILL.md"],
        "⑦.9_版式分析(可选)":   [".codex/skills/layout-reference-analyzer/SKILL.md"],
        "⑧_PreGen逻辑检查":    [".codex/skills/ai-image-logic-checker/SKILL.md"],
        "⑨_调用生图":           [".codex/skills/rh-image-pro-img2img/SKILL.md"],
        "⑩_PostGen逻辑检查":   [".codex/skills/ai-image-logic-checker/SKILL.md"],
        "⑪_审美评分":           [".codex/skills/ai-image-aesthetic-scorer/SKILL.md"],
    }
...
class DiagnosticEngine:
    ...
    def check_d2_module_registry(self):
        ...
        # V8.0：检查 .codex/skills/ 中是否有未注册的业务 Skill
        ...
        if skills_dir.is_dir():
            ...
            for sub in skills_dir.iterdir():
                if sub.is_dir():
                    ...
                    if skill_md.exists():
                        rel = f".codex/skills/{sub.name}/SKILL.md"
    ...
    def check_d3_rule_files(self):
        ...
        # 检查目录中是否有未注册的规则
        rule_dir = self.root / ".codex" / "rules"
        if rule_dir.is_dir():
