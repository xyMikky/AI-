...
- p��� **Optional Codex image flow**: generate documentary photos, infographics, flow diagrams, system maps, and UI scenes with GPT-Image 2.0 / GPT-M 2.0, then insert them at template-safe ratios
...
| Codex / other local agents | Works | Requires filesystem access and shell execution |
...
Paste the block above into Claude Code / Codex / any AI agent with shell access and it handles the install.
...
8. **Iterate** b�� use inline styles to tune font size, height, spacing
